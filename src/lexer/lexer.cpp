...
static bool is_alpha_or_digit(char ch) { return (is_alpha(ch) | is_digit(ch)); }
...
static std::unordered_map<std::string, token_type> keywords_token_table {
    ...
    { "float", token_type::k_float }, { "for", token_type::k_for }, { "goto", token_type::k_goto },

    { "if", token_type::k_if }, { "inline", token_type::k_inline }, { "int", token_type::k_int },
...
void lexer::tokenize_string_literal(lexer_results &results) noexcept
{
    ...
    results.tokens.emplace_back(
        token_type::l_string_literal, m_source.substr(m_suboffset, m_pos - m_suboffset));
}
...
void lexer::tokenize_number_literal(lexer_results &results)
{
    ...
    results.tokens.emplace_back(
        token_type::l_number_literal, m_source.substr(m_suboffset, m_pos - m_suboffset));
}
...
void lexer::tokenize_identifier(lexer_results &results)
{
    ...
    results.tokens.emplace_back(
        (keywords_token_table.contains(literal_value) ? keywords_token_table.at(literal_value)
