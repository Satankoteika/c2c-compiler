...
namespace ctc::lexer
{
    enum class token_type
    {
        ...
        k_default, k_do, k_double, k_else, k_enum, k_extern, k_float,
        ...
        p_leftparentheses, p_rightparentheses, // ( and )
        p_leftbrace, p_rightbrace, // { and }
        p_dot, p_arrow, // . and ->
        p_inc, p_dec, // ++ and --
        p_ampersand, p_star, // & and *
        p_plus, p_minus, // + and -
        p_tilde, p_exclmark, // ~ and !
        p_div, p_percentage, // / and %
        p_leftshift, p_rightshift, // << and >>
        ...
        p_equal, p_mulequal, // = and *=
        p_divequal, p_percequal, // /= and %=
